...
test('should create team-member relationship', async () => {
  ...
  expect(context.jobState.collectedRelationships).toEqual([
    expect.objectContaining({
      ...
      _key: '1e2fd576-c276-483d-8440-3c956e0fe015|has|2372b250-7a66-49db-88f6-14052ae638cc',
    ...
    expect.objectContaining({
      _class: 'HAS',
      _fromEntityKey: '1e2fd576-c276-483d-8440-3c956e0fe015',
      _key: '1e2fd576-c276-483d-8440-3c956e0fe015|has|fdc6ef12-ed55-44b7-83a9-09b1a9c35ea8',
